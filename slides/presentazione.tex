...
\begin{frame}{Scalabilità sui dati: confronto a pari scala}
  \small \textbf{Confronto diretto} all'\dato{unica scala comparabile} (${\sim}230$--$240$ ditte, 4 nodi); entrambi i sistemi partono dalla stessa base di 30 ditte.
  \vspace{0.1em}
  \centering
  \scriptsize
  \setlength{\tabcolsep}{5pt}
  \renewcommand{\arraystretch}{0.92}
  \begin{tabular}{@{}l >{\columncolor{pgblu!9}}r >{\columncolor{mongoverde!9}}r l@{}}
    \toprule
    \textbf{Query} & \textcolor{pgblu}{\textbf{Citus}} (240) & \textcolor{mongoverde}{\textbf{MongoDB}} (230) & \textbf{più veloce} \\
    \midrule
    L01 cedolino        & 1.4  & 2.6  & \textcolor{pgblu}{Citus} \\
    L02 cedolini ditta  & 1.6  & 3.0  & \textcolor{pgblu}{Citus} \\
    L03 costo/centro    & 2.4  & 3.4  & \textcolor{grigio}{$\approx$} \\
    L04 gender gap      & 30.9 & 26.0 & \textcolor{mongoverde}{Mongo} \\
    L05 top-N           & 15.7 & 7.9  & \textcolor{mongoverde}{Mongo 2$\times$} \\
    L06 assenteismo     & 51.2 & 302  & \textcolor{pgblu}{\textbf{Citus 6$\times$}} \\
    L07 straordinari    & 3.2  & 3.6  & \textcolor{grigio}{$\approx$} \\
    L08 trend costo     & 14.9 & 29.0 & \textcolor{pgblu}{Citus 2$\times$} \\
    L09 organico        & 16.8 & 19.7 & \textcolor{grigio}{$\approx$} \\
    L10 ced.\ completo  & 21.3 & 2.4  & \textcolor{mongoverde}{\textbf{Mongo 9$\times$}} \\
    L11 spesa/cat.      & 66.0 & 34.2 & \textcolor{mongoverde}{Mongo 2$\times$} \\
    L12 ferie residue   & 28.3 & 476  & \textcolor{pgblu}{\textbf{Citus 17$\times$}} \\
    L13 riepilogo       & 3.6  & 33.8 & \textcolor{pgblu}{\textbf{Citus 9$\times$}} \\
    \bottomrule
  \end{tabular}
  \par\vspace{0.15em}
  {\scriptsize\color{grigio} Le scale massime differiscono perché \textbf{sotto ${\sim}230$ ditte il balancer di Mongo non distribuisce} (cedolini ${<}300$\,MB): a quel volume il confronto non sarebbe corretto. In sintesi, Citus prevale sul \textcolor{pgblu}{\textbf{multi-entità}}, Mongo sull'\textcolor{mongoverde}{\textbf{aggregato}}.}
\end{frame}
